...
async function deployMultipleRecipientStream() {
    ...
    const multipleRecipientStreamFactory = new MultipleRecipientStreamFactory(alice);
    const multipleRecipientStream = await multipleRecipientStreamFactory.deploy();
    await multipleRecipientStream.deployed();
    console.log("Deployed Multiple Recipient Stream at " + multipleRecipientStream.address);
